...
local aa = {
    function()
        ...
        function x.Resize(x, y)
            local z, A, B = x / 1920, y / 1080, j.ViewportSize
            return B.X * z, B.Y * A
        end
        ...
        return function(t)
            ...
            m.AddSignal(h.InputChanged, function(M)
                ...
                if (M.UserInputType == Enum.UserInputType.MouseMovement or M.UserInputType == Enum.UserInputType.Touch) and A then
                    ...
                    local Q = Vector2.new(math.clamp(P.X, v.MinSize.X, 2048), math.clamp(P.Y, v.MinSize.Y, 2048))
                    G:setGoal{
                        X = l.Instant.new(Q.X),
                        Y = l.Instant.new(Q.Y)
                    }
            ...
            function v.AddTab(Q, P)
                return N:New(P.Title, P.Icon, v.TabHolder)
            end
            function v.SelectTab(z, P)
                N:SelectTab(P)
            end
            m.AddSignal(
    ...
    [26] = function()
        ...
        function c.New(d, e, f)
            ...
            local h, i, j = {
                ...
                Min = f.Min,
                Max = f.Max,
                Rounding = f.Rounding or 0,
                Callback = f.Callback or function(h)
                end,
                Changed = f.Changed or function()
                end,
                Type = "Slider"
    ...
    [28] = function()
        ...
        return {
            assets = {
                ...
                ["castle"] = "rbxassetid://113826256227095",
                ["cat"] = "",
    ...
    [54] = function()
        ...
        return {
            ...
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 42, 54), Color3.fromRGB(36, 39, 50)),
            AcrylicNoise = 0.8,
    ...
    [56] = function()
        ...
        return {
            ...
            AcrylicMain = Color3.fromRGB(30, 30, 30), 
            AcrylicBorder = Color3.fromRGB(60, 60, 60), 
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(20, 40, 90), Color3.fromRGB(30, 60, 130)),
            AcrylicNoise = 0.85, 
