local a, b = {
    {1, "ModuleScript", {"MainModule"}, {
        ...
        {47, "ModuleScript", {"Themes"}, {
            ...
            {54, "ModuleScript", {"Dracula"}},
            {55, "ModuleScript", {"Blue"}},
            {56, "ModuleScript", {"BlueWave"}},
            {57, "ModuleScript", {"Black"}},
            {58, "ModuleScript", {"Dark Violet"}},
            {59, "ModuleScript", {"Vampire"}},
            {60, "ModuleScript", {"Rainbow"}},
            {61, "ModuleScript", {"Luffy"}},
            {62, "ModuleScript", {"Green"}},
        }},
...
local aa = {
	...
	function()
		...
		return function(m)
			...
			h.AddSignal(
                q:GetPropertyChangedSignal"AbsolutePosition", function()
				o(q)
			end)
			h.AddSignal(
                q:GetPropertyChangedSignal"AbsoluteSize", function()
				o(q)
			end)
			n.AddParent = function(r)
				h.AddSignal(
                    r:GetPropertyChangedSignal"Visible", function()
	...
	[9] = function()
		...
		return function(m, n, o)
			...
			j.AddSignal(
                p.Frame.MouseEnter, function()
				r(0.97)
			end)
			j.AddSignal(
                p.Frame.MouseLeave, function()
				r(1)
			end)
			j.AddSignal(
                p.Frame.MouseButton1Down, function()
				r(1)
			end)
			j.AddSignal(
                p.Frame.MouseButton1Up, function()
				r(0.97)
			end)
			return p
		end
	...
	[10] = function()
		...
		function q.Create(r)
			...
			function s.Button(z, A, B)
				...
				m.AddSignal(
                    C.Frame.MouseButton1Click, function()
					e(k):SafeCallback(B)
					pcall(
                            function()
						s:Close()
	...
	[11] = function()
		...
		return function(m, n, o, p)
			...
			q:SetDesc(n)
			if p then
				local r, s, t = h.Themes, j.SpringMotor(
                        j.GetThemeProperty"ElementTransparency", q.Frame, "BackgroundTransparency", false, true)
				j.AddSignal(
                    q.Frame.MouseEnter, function()
					t(j.GetThemeProperty"ElementTransparency" - j.GetThemeProperty"HoverChange")
				end)
				j.AddSignal(
                    q.Frame.MouseLeave, function()
					t(j.GetThemeProperty"ElementTransparency")
				end)
				j.AddSignal(
                    q.Frame.MouseButton1Down, function()
					t(j.GetThemeProperty"ElementTransparency" + j.GetThemeProperty"HoverChange")
				end)
				j.AddSignal(
                    q.Frame.MouseButton1Up, function()
					t(j.GetThemeProperty"ElementTransparency" - j.GetThemeProperty"HoverChange")
				end)
			end
			return q
	...
	[12] = function()
		...
		function o.New(p, q)
			...
			j.AddSignal(
                r.CloseButton.MouseButton1Click, function()
				r:Close()
			end)
			function r.Open(t)
	...
	[13] = function()
		...
		return function(k, l)
			...
			i.AddSignal(
                m.Layout:GetPropertyChangedSignal"AbsoluteContentSize", function()
	...
	[14] = function()
		...
		function o.New(p, q, r, s)
			...
			j.AddSignal(
                y:GetPropertyChangedSignal"AbsoluteContentSize", function()
			...
			j.AddSignal(
                x.Frame.MouseEnter, function()
				x.SetTransparency(x.Selected and 0.85 or 0.89)
			end)
			j.AddSignal(
                x.Frame.MouseLeave, function()
				x.SetTransparency(x.Selected and 0.89 or 1)
			end)
			j.AddSignal(
                x.Frame.MouseButton1Down, function()
				x.SetTransparency(0.92)
			end)
			j.AddSignal(
                x.Frame.MouseButton1Up, function()
				x.SetTransparency(x.Selected and 0.85 or 0.89)
			end)
			j.AddSignal(
                x.Frame.MouseButton1Click, function()
				o:SelectTab(w)
			end)
	...
	[16] = function()
		...
		return function(n)
			local o, p, q = {}, e(h), function(o, p, q, r)
				...
				m(
                        s.Frame.MouseButton1Down, function()
					u(0.96)
				end)
				m(
                        s.Frame.MouseButton1Up, function()
					u(0.94)
				end)
			...
			o.CloseButton = q(
                i.Close, UDim2.new(1, -4, 0, 4), o.Frame, function()
				p.Window:Dialog{
					Title = "Close",
			...
			o.MaxButton = q(
                i.Max, UDim2.new(1, -40, 0, 4), o.Frame, function()
				n.Window.Maximize(not n.Window.Maximized)
			end)
			o.MinButton = q(
                i.Min, UDim2.new(1, -80, 0, 4), o.Frame, function()
				p.Window:Minimize()
			end)
			return o
		end
		...
		return function(t)
			local u, v, w, x, y, z = e(k), {
				...
				Position = UDim2.fromOffset(
                        j.ViewportSize.X / 2 - t.Size.X.Offset / 2, j.ViewportSize.Y / 2 - t.Size.Y.Offset / 2)
			}, false
			local A, B = false
			local C = false
            ...
            v.ChangeSize = function()
				...
				G:setGoal {
                    X = l["Spring"].new(P, {frequency = 6}),
                    Y = l["Spring"].new(Q, {frequency = 6})
                }
                v.Size = UDim2.fromOffset(P, Q)
				H:setGoal {
			...
			m.AddSignal(
                v.TitleBar.Frame.InputBegan, function(M)
				if M.UserInputType == Enum.UserInputType.MouseButton1 or M.UserInputType == Enum.UserInputType.Touch then
					...
					if v.Maximized then
						z = UDim2.fromOffset(
                                i.X - (i.X * ((K - 100) / v.Root.AbsoluteSize.X)), i.Y - (i.Y * (L / v.Root.AbsoluteSize.Y)))
					end
					M.Changed:Connect(
                            function()
			...
			m.AddSignal(
                v.TabHolder.UIListLayout:GetPropertyChangedSignal"AbsoluteContentSize", function()
				v.TabHolder.CanvasSize = UDim2.new(0, 0, 0, v.TabHolder.UIListLayout.AbsoluteContentSize.Y)
			end)
			m.AddSignal(
                h.InputBegan, function(M)
			...
			m.AddSignal(
                v.TabHolder:GetPropertyChangedSignal"CanvasPosition", function()
	...
	[20] = function()
		...
		function l.New(m, n)
			...
			i.AddSignal(
                o.Frame.MouseButton1Click, function()
	...
	[21] = function()
		...
		function u.New(v, w, x)
			...
			p.AddSignal(
                A.Frame.MouseButton1Click, function()
				ab()
			end)
			z:Display()
			y.Options[w] = z
	...
	[22] = function()
		...
		function g.New(h, i, j)
			...
			c.AddSignal(
                p.MouseButton1Click, function()
				l:Open()
			end)
			c.AddSignal(
                ag.InputBegan, function(A)
			...
			function l.Open(B)
				...
				v.Visible = true
				af:Create(
                    u, TweenInfo.new(0.2, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
					Size = UDim2.fromScale(1, 1)
				}):Play()
			end
			function l.Close(B)
			...
			function l.BuildDropdownList(B)
				...
				for H, I in next, C do
					...
					c.AddSignal(
                        M.MouseButton1Down, function()
						P(0.92)
					end)
					c.AddSignal(
                        M.MouseButton1Up, function()
						P(N and 0.85 or 0.89)
					end)
	...
	[23] = function()
		...
		function c.New(d, e, f)
			...
			if h.Finished then
				...
				ai(
                    k:GetPropertyChangedSignal"Text", function()
					h:SetValue(k.Text)
				end)
			end
	...
	[24] = function()
		...
		function c.New(d, e, f)
			...
			ah.AddSignal(
                l.InputBegan, function(m)
				if m.UserInputType == Enum.UserInputType.MouseButton1 or m.UserInputType == Enum.UserInputType.Touch then
					i = true
					k.Text = "..."
					wait(0.2)
					local n
					n = af.InputBegan:Connect(
                            function(o)
						local p
	...
	[27] = function()
		...
		function c.New(d, e, f)
			...
			function h.SetValue(m, n)
				...
				af:Create(
                    j, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
					Position = UDim2.new(0, h.Value and 19 or 2, 0.5, 0)
				}):Play()
				af:Create(
                    l, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
			...
			ah.AddSignal(
                i.Frame.MouseButton1Click, function()
	...
	[31] = function()
		...
		function ai.start(aj)
			if not aj._connection then
				aj._connection = af.RenderStepped:Connect(
                    function(c)
					aj:step(c)
				end)
			end
    ...
    [54] = function()
        ...
        return {
            ...
            AcrylicMain = Color3.fromRGB(36, 39, 50),
            AcrylicBorder = Color3.fromRGB(68, 71, 90),
            AcrylicGradient1 = Color3.fromRGB(40, 42, 54),
            AcrylicGradient2 = Color3.fromRGB(36, 39, 50),
            AcrylicNoise = 0.8,
            TitleBarLine = Color3.fromRGB(98, 114, 164),
            Tab = Color3.fromRGB(80, 88, 120),
            Element = Color3.fromRGB(50, 52, 63),
            ElementBorder = Color3.fromRGB(40, 42, 54),
            InElementBorder = Color3.fromRGB(68, 71, 90),
            ElementTransparency = 0.85,
            ToggleSlider = Color3.fromRGB(80, 250, 123),
            ToggleToggled = Color3.fromRGB(189, 147, 249),
            SliderRail = Color3.fromRGB(68, 71, 90),
            DropdownFrame = Color3.fromRGB(50, 52, 63),
            DropdownHolder = Color3.fromRGB(36, 39, 50),
            DropdownBorder = Color3.fromRGB(40, 42, 54),
            DropdownOption = Color3.fromRGB(248, 248, 242),
            Keybind = Color3.fromRGB(255, 184, 108),
            Input = Color3.fromRGB(50, 52, 63),
            InputFocused = Color3.fromRGB(255, 121, 198),
            InputIndicator = Color3.fromRGB(80, 250, 123),
            Dialog = Color3.fromRGB(36, 39, 50),
            DialogHolder = Color3.fromRGB(50, 52, 63),
            DialogHolderLine = Color3.fromRGB(68, 71, 90),
            DialogButton = Color3.fromRGB(98, 114, 164),
            DialogButtonBorder = Color3.fromRGB(40, 42, 54),
            DialogBorder = Color3.fromRGB(68, 71, 90),
            DialogInput = Color3.fromRGB(40, 42, 54),
            DialogInputLine = Color3.fromRGB(255, 121, 198),
            Text = Color3.fromRGB(248, 248, 242),
            SubText = Color3.fromRGB(139, 233, 253),
            Hover = Color3.fromRGB(80, 250, 123),
            HoverChange = 0.1
        }
    end,
    [55] = function()
        ...
        return {
            ...
            DropdownBorder = Color3.fromRGB(135, 206, 235),
            ...
            DialogButtonBorder = Color3.fromRGB(135, 206, 235),
            DialogBorder = Color3.fromRGB(135, 206, 235),
            DialogInput = Color3.fromRGB(55, 55, 55),
            DialogInputLine = Color3.fromRGB(160, 160, 160),
            Text = Color3.fromRGB(240, 240, 240),
            SubText = Color3.fromRGB(170, 170, 170),
            Hover = Color3.fromRGB(135, 206, 235),
            HoverChange = 0.07
        }
    end,
    [56] = function()
        ...
        return {
            Name = "BlueWave",
            Accent = Color3.fromRGB(42, 87, 240), 
            AcrylicMain = Color3.fromRGB(30, 30, 30), 
            AcrylicBorder = Color3.fromRGB(60, 60, 60), 
            AcrylicGradient1 = Color3.fromRGB(20, 40, 90), 
            AcrylicGradient2 = Color3.fromRGB(30, 60, 130), 
            AcrylicNoise = 0.85, 
            ...
            ToggleToggled = Color3.fromRGB(0, 112, 255), 
            ...
            InputIndicator = Color3.fromRGB(90, 90, 255), 
            Dialog = Color3.fromRGB(30, 30, 30), 
            DialogHolder = Color3.fromRGB(50, 50, 50), 
            DialogHolderLine = Color3.fromRGB(80, 80, 80), 
            ...
            Hover = Color3.fromRGB(60, 60, 255), 
            HoverChange = 0.1 
        }
    end,
    [57] = function()
        ...
        return {
            ...
            AcrylicGradient1 = Color3.fromRGB(20, 20, 20),
            AcrylicGradient2 = Color3.fromRGB(0, 0, 0),
            AcrylicNoise = 0.92,
    ...
    [59] = function()
        ...
        return {
            ...
            AcrylicMain = Color3.fromRGB(0, 0, 0),
            AcrylicBorder = Color3.fromRGB(139, 0, 0),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(0, 0, 0), Color3.fromRGB(0, 0, 0)),
            AcrylicNoise = 0.9,
            ...
            InElementBorder = Color3.fromRGB(139, 0, 0),
            ElementTransparency = 0.87,
            ToggleSlider = Color3.fromRGB(255, 255, 255),
            ToggleToggled = Color3.fromRGB(255, 255, 255),
            SliderRail = Color3.fromRGB(255, 255, 255),
            ...
            DialogButton = Color3.fromRGB(52, 52, 52),
            DialogButtonBorder = Color3.fromRGB(139, 0, 0),
            DialogBorder = Color3.fromRGB(139, 0, 0),
            DialogInput = Color3.fromRGB(55, 55, 55),
            DialogInputLine = Color3.fromRGB(160, 160, 160),
            Text = Color3.fromRGB(240, 240, 240),
            SubText = Color3.fromRGB(170, 170, 170),
            Hover = Color3.fromRGB(139, 0, 0),
            HoverChange = 0.07
        }
    end,
    [60] = function()
