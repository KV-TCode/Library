...
local aa = {
    ...
    function()
        ...
        return function(k)
            ...
            l.Frame = j("Frame", {
            ...
            }), j("UICorner", {CornerRadius = UDim.new(0, 8)}), j("Frame", {
                ...
                Size = UDim2.fromScale(1, 1),
                BackgroundTransparency = 1
            }, {j("UICorner", {CornerRadius = UDim.new(0, 8)})}), j("ImageLabel", {
            ...
            }, {j("UICorner", {CornerRadius = UDim.new(0, 8)})}), j("Frame", {BackgroundTransparency = 1, Size = UDim2.fromScale(1, 1), ZIndex = 2}, {
                j("UICorner", {CornerRadius = UDim.new(0, 8)}),
        ...
        return function(t)
            ...
            function v.Minimize(M)
                ...
                if not C then
                    ...
                    u:Notify {
                        Title = "Interface ThunderZ GUI",
                        Content = "Press " .. N .. " to open the menu back.",
                        Duration = 6
                    }
                end
            end
